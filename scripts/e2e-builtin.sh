...
grep -o "\"name\":\"TodoWrite\"[^\"]*.\"content\":\"[^\"]*" /tmp/bb11/projects/-src/*/events.jsonl | tail -1 | head -c 120; echo
test ! -f /tmp/bb11/projects/-src/*/todo.md && echo "(no todo.md file — correct, history is the state)"
